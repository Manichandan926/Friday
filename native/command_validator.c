...
static const char *WHITELIST[] = {
    ...
    "lsof",       "lspci",      "lsusb",      "md5sum",     "neofetch",
    "netstat",    "nmcli",      "node",       "npm",        "nslookup",
    "pgrep",      "ping",       "pip",        "pip3",       "pmap",
    "printenv",   "ps",         "python",     "python3",    "readlink",
    "realpath",   "rustc",      "sar",        "screenfetch","sed",
    "sensors",    "sha256sum",  "sort",       "ss",         "stat",
    "strace",     "strings",    "systemctl",  "tail",       "tee",
    "timedatectl","top",        "tr",         "traceroute", "type",
    "uname",      "uniq",       "upower",     "uptime",     "vmstat",
    "wc",         "whereis",    "which",      "who",        "whoami",
    "xargs",
};
